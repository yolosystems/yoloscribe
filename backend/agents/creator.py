...
5. Ask how the agent should be triggered:
   ...
   - "on_write": runs whenever the current page's content.md is saved. The agent is
     defined on the page it watches — no scope patterns needed; each agent watches
     exactly its own page.
...
6. Call put_agent once everything is confirmed, passing trigger, and schedule/timezone
